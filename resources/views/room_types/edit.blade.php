            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('room-types.update', $roomType->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            <x-input-label for="price_per_night" :value="__('Harga per Malam (Rp)')" />
                            <x-text-input id="price_per_night" class="block mt-1 w-full" type="number"
                                name="price_per_night" :value="old('price_per_night', $roomType->price_per_night)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $roomType->description) }}</textarea>
