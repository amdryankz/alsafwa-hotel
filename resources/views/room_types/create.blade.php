                    ...
                    <form action="{{ route('room-types.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price_per_night"
                                class="block mt-1 w-full dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200 dark:placeholder-gray-500"
                                type="number" name="price_per_night" :value="old('price_per_night')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description') }}</textarea>
