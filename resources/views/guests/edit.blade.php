                    ...
                    <form action="{{ route('guests.update', $guest->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="name"
                                ...
                                type="text" name="name" :value="old('name', $guest->name)" required autofocus />
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <select name="id_type" id="id_type"
                                    ...
                                    required>
                                    <option value="KTP" @selected(old('id_type', $guest->id_type) == 'KTP')>KTP</option>
                                    <option value="Paspor" @selected(old('id_type', $guest->id_type) == 'Paspor')>Paspor</option>
                                </select>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="id_number"
                                    class="block mt-1 w-full dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200 dark:placeholder-gray-500"
                                    type="text" name="id_number" :value="old('id_number', $guest->id_number)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="phone_number"
                                class="block mt-1 w-full dark:bg-gray-900 dark:border-gray-700 dark:text-gray-200 dark:placeholder-gray-500"
                                type="text" name="phone_number" :value="old('phone_number', $guest->phone_number)" />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="address" id="address" rows="3"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('address', $guest->address) }}</textarea>
