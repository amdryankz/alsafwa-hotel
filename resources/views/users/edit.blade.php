<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Data Karyawan') }}</h2>
    </x-slot>
    <div class="py-12">
                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="role" id="role" class="block mt-1 w-full border-gray-300 rounded-md"
                                required>
                                <option value="front_office" @selected($user->role == 'front_office')>Staff Front Office</option>
                                <option value="accountant" @selected($user->role == 'accountant')>Akuntan</option>
